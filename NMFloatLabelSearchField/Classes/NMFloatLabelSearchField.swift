...
open class NMFloatLabelSearchField: SkyFloatingLabelTextField {
    ...
    override open func willMove(toSuperview newSuperview: UIView?) {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(NMFloatLabelSearchField.keyboardWillShow(_:)), name: NSNotification.Name.UIKeyboardWillShow, object: nil)
        NotificationCenter.default.addObserver(self, selector: #selector(NMFloatLabelSearchField.keyboardWillHide(_:)), name: NSNotification.Name.UIKeyboardWillHide, object: nil)
        NotificationCenter.default.addObserver(self, selector: #selector(NMFloatLabelSearchField.keyboardDidChangeFrame(_:)), name: NSNotification.Name.UIKeyboardDidChangeFrame, object: nil)
    }
